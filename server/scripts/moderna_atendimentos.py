...
def fetch_day(date_str):
    """Busca atendimentos de um dia (formato YYYYMMDD)."""
...
def run():
    print(f"Iniciando carga Moderna Atendimentos (ultimos {DAYS_BACK} dias)...\n")
    ...
    for i in range(DAYS_BACK, -1, -1):
        ...
        print(f"Buscando {day.strftime('%d/%m/%Y')}...", end=" ", flush=True)
